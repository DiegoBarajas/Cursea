    ...
    <head>
        ...
        <?php
            ...
            if((!isset($_SESSION['tema'])) || ($_SESSION['tema'] == "claro")){
                ...
                echo '<link rel="stylesheet" href="categoria.css">';

            }else if($_SESSION['tema'] == "oscuro"){

                echo '<link rel="stylesheet" href="categoria_osc.css">';
...
<!------------------------ MAIN ------------------------------------------------------------------------------------------------>
        ...
        <main class="main-maq-centro">
            ...
            <article class="article-nombre-curso">
                ...
                <h2 class="h2-categoria titulo"><?php echo $categoria ?></h2>

                <img src="/img/categoria/<?php echo $categoria ?>_osc.png" class="img-cate">
