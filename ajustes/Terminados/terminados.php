...
<html lang="es">
    ...
    <head>
        ...
        <link rel="stylesheet" href="terminados.css">
        ...
        <?php
            ...
            if((!isset($_SESSION['tema'])) || ($_SESSION['tema'] == "claro")){
                ...
                echo '<link rel="stylesheet" href="terminados.css">';

            }else if($_SESSION['tema'] == "oscuro"){

                echo '<link rel="stylesheet" href="terminados_osc.css">';

            }



           echo '<title>Cursea - Cursos Terminados </title>';
...
<!------------------------ MAIN ------------------------------------------------------------------------------------------------>
        ...
        <main class="main-maq-centro">
            ...
            <article class="article-nombre-curso">
                ...
                <h2 class="h2-categoria titulo">Cursos Terminados</h2>

                <img src="/img/ajustes/terminado.png" class="img-cate">
            ...
            <?php
                ...
                $sql = "SELECT * FROM status_curso WHERE id_usuario='$id' AND status=1;";
                ...
                if($res->num_rows==0){
                    ...
                    echo "<h1 class='h1-noporolo titulo'>No haz terminado ningun curso";
                ...
                while($r=$res->fetch_assoc()){
                    ...
                    <section class="row">
                        ...
                        <section class="sect-quitar-fav" onclick="redireccion(' . $curso . ')">

                            <img src="/img/ajustes/marcar-pendiente.png" class="img-quitar">

                            <p class="a-quitar contenido">Marcar como Pendiente</p>
...
<!------------------------ FOOTER------------------------------------------------------------------------------------------->
    ...
    <script src="terminados.js"></script>
