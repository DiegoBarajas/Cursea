    ...
    <head>
        ...
        <?php
            ...
            if((!isset($_SESSION['tema'])) || ($_SESSION['tema'] == "claro")){
                ...
                echo '<link rel="stylesheet" href="pendientes.css">';

            }else if($_SESSION['tema'] == "oscuro"){

                echo '<link rel="stylesheet" href="pendientes_osc.css">';

            }



           echo '<title>Cursea - Cursos Pendientes </title>';
...
<!------------------------ MAIN ------------------------------------------------------------------------------------------------>
        ...
        <main class="main-maq-centro">
            ...
            <article class="article-nombre-curso">
                ...
                <h2 class="h2-categoria titulo">Cursos Pendientes</h2>

                <img src="/img/ajustes/pendiente.png" class="img-cate">
            ...
            <?php
                ...
                $sql = "SELECT * FROM status_curso WHERE id_usuario='$id' AND status=0;";
                ...
                if($res->num_rows==0){
                    ...
                    echo "<h1 class='h1-noporolo titulo'>No hay ningun curso pendiente";
                ...
                while($r=$res->fetch_assoc()){
                    ...
                    <section class="row">
                        ...
                        <section class="sect-quitar-fav" onclick="redireccion(' . $curso . ')">
                            ...
                            <img src="/img/ajustes/marcar_terminado.png" class="img-quitar">

                            <p class="a-quitar contenido">Marcar como Terminado</p>
